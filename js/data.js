...
const WORDS_HIRAGANA = [
  ...
  { word: 'ちょう',   romaji: 'chō',       alt: ['chou'],    emoji: '🦋',  meaning: 'mariposa' },
  { word: 'はと',     romaji: 'hato',      emoji: '🕊️',  meaning: 'paloma' },
  { word: 'しか',     romaji: 'shika',     emoji: '🦌',  meaning: 'ciervo' },
  { word: 'ぞう',     romaji: 'zō',        alt: ['zou'],     emoji: '🐘',  meaning: 'elefante' },
  ...
  { word: 'こうもり', romaji: 'kōmori',    alt: ['koumori'], emoji: '🦇',  meaning: 'murciélago' },
  // Naturaleza
  ...
  { word: 'がっこう', romaji: 'gakkō',     alt: ['gakkou'],  emoji: '🏫',  meaning: 'escuela' },
  ...
  { word: 'とけい',   romaji: 'tokē',      alt: ['tokei'],   emoji: '⏰',  meaning: 'reloj' },
  ...
  { word: 'べんとう', romaji: 'bentō',     alt: ['bentou'],  emoji: '🍱',  meaning: 'bento' },
  ...
  { word: 'あひる',     romaji: 'ahiru',      emoji: '🦆',  meaning: 'pato' },
  { word: 'ひよこ',     romaji: 'hiyoko',     emoji: '🐥',  meaning: 'pollito' },
  { word: 'おおかみ',   romaji: 'ōkami',      alt: ['ookami'],    emoji: '🐺',  meaning: 'lobo' },
  { word: 'ほたる',     romaji: 'hotaru',     emoji: '🪲',  meaning: 'luciérnaga' },
  { word: 'かたつむり', romaji: 'katatsumuri',emoji: '🐌',  meaning: 'caracol' },
  { word: 'むし',       romaji: 'mushi',      emoji: '🐛',  meaning: 'insecto' },
  { word: 'にわとり',   romaji: 'niwatori',   emoji: '🐓',  meaning: 'gallina' },
  // Colores adicionales
  { word: 'むらさき',   romaji: 'murasaki',   emoji: '🟣',  meaning: 'morado' },
  { word: 'ちゃいろ',   romaji: 'chairo',     emoji: '🟤',  meaning: 'marrón' },
  { word: 'はいいろ',   romaji: 'haiīro',    alt: ['haiiro'],    emoji: '🩶',  meaning: 'gris' },
  // Verduras y comida adicional
  { word: 'にんじん',   romaji: 'ninjin',     emoji: '🥕',  meaning: 'zanahoria' },
  { word: 'たまねぎ',   romaji: 'tamanegi',   emoji: '🧅',  meaning: 'cebolla' },
  { word: 'なす',       romaji: 'nasu',       emoji: '🍆',  meaning: 'berenjena' },
  { word: 'きゅうり',   romaji: 'kyūri',     alt: ['kyuuri'],    emoji: '🥒',  meaning: 'pepino' },
  { word: 'じゃがいも', romaji: 'jagaimo',    emoji: '🥔',  meaning: 'papa' },
  { word: 'かぼちゃ',   romaji: 'kabocha',    emoji: '🎃',  meaning: 'zapallo' },
  { word: 'おかし',     romaji: 'okashi',     emoji: '🍭',  meaning: 'golosina' },
  { word: 'てんぷら',   romaji: 'tenpura',    emoji: '🍤',  meaning: 'tempura' },
  { word: 'とんかつ',   romaji: 'tonkatsu',   emoji: '🥩',  meaning: 'milanesa de cerdo' },
  { word: 'そうめん',   romaji: 'sōmen',     alt: ['soumen'],    emoji: '🍝',  meaning: 'fideos somen' },
  { word: 'ちゃわん',   romaji: 'chawan',     emoji: '🍵',  meaning: 'cuenco de arroz' },
  // Cuerpo adicional
  { word: 'ゆび',       romaji: 'yubi',       emoji: '👆',  meaning: 'dedo' },
  { word: 'のど',       romaji: 'nodo',       emoji: '🗣️',  meaning: 'garganta' },
  { word: 'おなか',     romaji: 'onaka',      emoji: '🫁',  meaning: 'barriga' },
  { word: 'せなか',     romaji: 'senaka',     emoji: '🔙',  meaning: 'espalda' },
  { word: 'ひざ',       romaji: 'hiza',       emoji: '🦵',  meaning: 'rodilla' },
  { word: 'かた',       romaji: 'kata',       emoji: '💪',  meaning: 'hombro' },
  { word: 'むね',       romaji: 'mune',       emoji: '💗',  meaning: 'pecho' },
  // Lugares adicionales
  { word: 'こうえん',   romaji: 'kōen',      alt: ['kouen'],     emoji: '🌳',  meaning: 'parque' },
  { word: 'えき',       romaji: 'eki',        emoji: '🚉',  meaning: 'estación de tren' },
  { word: 'くうこう',   romaji: 'kūkō',      alt: ['kuukou'],    emoji: '✈️',  meaning: 'aeropuerto' },
  { word: 'としょかん', romaji: 'toshokan',   emoji: '📚',  meaning: 'biblioteca' },
  { word: 'びょういん', romaji: 'byōin',     alt: ['byouin'],    emoji: '🏥',  meaning: 'hospital' },
  { word: 'みなと',     romaji: 'minato',     emoji: '⚓',  meaning: 'puerto' },
  { word: 'にわ',       romaji: 'niwa',       emoji: '🌿',  meaning: 'jardín' },
  // Vida cotidiana
  { word: 'でんき',     romaji: 'denki',      emoji: '💡',  meaning: 'electricidad / luz' },
  { word: 'かぎ',       romaji: 'kagi',       emoji: '🔑',  meaning: 'llave' },
  { word: 'たたみ',     romaji: 'tatami',     emoji: '🪘',  meaning: 'tatami' },
  { word: 'ふとん',     romaji: 'futon',      emoji: '🛏️',  meaning: 'futón' },
  { word: 'じかん',     romaji: 'jikan',      emoji: '⏰',  meaning: 'tiempo / hora' },
  { word: 'かいもの',   romaji: 'kaimono',    emoji: '🛒',  meaning: 'compras' },
  { word: 'りょこう',   romaji: 'ryokō',     alt: ['ryokou'],    emoji: '🗺️',  meaning: 'viaje' },
  // Profesiones e idiomas
  { word: 'いしゃ',     romaji: 'isha',       emoji: '👨‍⚕️',  meaning: 'médico' },
  { word: 'べんごし',   romaji: 'bengoshi',   emoji: '⚖️',  meaning: 'abogado' },
  { word: 'にほんご',   romaji: 'nihongo',    emoji: '🗾',  meaning: 'japonés (idioma)' },
  { word: 'えいご',     romaji: 'ēgo',       alt: ['eigo'],      emoji: '🇬🇧',  meaning: 'inglés (idioma)' },
  // Naturaleza adicional
  { word: 'こおり',     romaji: 'kōri',      alt: ['koori'],     emoji: '🧊',  meaning: 'hielo' },
  { word: 'いけ',       romaji: 'ike',        emoji: '🏞️',  meaning: 'estanque' },
  // Deportes japoneses
  { word: 'やきゅう',   romaji: 'yakyū',     alt: ['yakyuu'],    emoji: '⚾',  meaning: 'béisbol' },
  { word: 'すもう',     romaji: 'sumō',      alt: ['sumou'],     emoji: '🤼',  meaning: 'sumo' },
  { word: 'じゅうどう', romaji: 'jūdō',      alt: ['juudou'],    emoji: '🥋',  meaning: 'judo' },
  { word: 'からて',     romaji: 'karate',     emoji: '🥋',  meaning: 'karate' },
  { word: 'けんどう',   romaji: 'kendō',     alt: ['kendou'],    emoji: '⚔️',  meaning: 'kendo' },
  // Días de la semana
  { word: 'にちようび', romaji: 'nichiyōbi', alt: ['nichiyoubi'], emoji: '☀️',  meaning: 'domingo' },
  { word: 'げつようび', romaji: 'getsuyōbi', alt: ['getsuyoubi'], emoji: '🌕',  meaning: 'lunes' },
  { word: 'かようび',   romaji: 'kayōbi',   alt: ['kayoubi'],    emoji: '🔥',  meaning: 'martes' },
  { word: 'すいようび', romaji: 'suiyōbi',  alt: ['suiyoubi'],   emoji: '💧',  meaning: 'miércoles' },
  { word: 'もくようび', romaji: 'mokuyōbi', alt: ['mokuyoubi'],  emoji: '🌲',  meaning: 'jueves' },
  { word: 'きんようび', romaji: "kin'yōbi", alt: ['kinyoubi'],   emoji: '💰',  meaning: 'viernes' },
  { word: 'どようび',   romaji: 'doyōbi',   alt: ['doyoubi'],    emoji: '🌊',  meaning: 'sábado' },
];

const WORDS_KATAKANA = [
  // Bebidas
  { word: 'コーヒー',       romaji: 'kōhī',        alt: ['koohii'],      emoji: '☕',  meaning: 'café' },
  { word: 'ジュース',       romaji: 'jūsu',         alt: ['juusu'],       emoji: '🧃',  meaning: 'jugo' },
  { word: 'ミルク',         romaji: 'miruku',                             emoji: '🥛',  meaning: 'leche' },
  { word: 'ビール',         romaji: 'bīru',         alt: ['biiru'],       emoji: '🍺',  meaning: 'cerveza' },
  { word: 'ワイン',         romaji: 'wain',                               emoji: '🍷',  meaning: 'vino' },
  { word: 'アイスティー',   romaji: 'aisutī',       alt: ['aisutii'],     emoji: '🧋',  meaning: 'té helado' },
  // Comida
  { word: 'パン',           romaji: 'pan',                                emoji: '🍞',  meaning: 'pan' },
  { word: 'ケーキ',         romaji: 'kēki',         alt: ['keeki'],       emoji: '🎂',  meaning: 'torta' },
  ...
  { word: 'チョコレート',   romaji: 'chokorēto',    alt: ['chokoreeto'],  emoji: '🍫',  meaning: 'chocolate' },
  { word: 'ラーメン',       romaji: 'rāmen',        alt: ['raamen'],      emoji: '🍜',  meaning: 'ramen' },
  { word: 'カレー',         romaji: 'karē',         alt: ['karee'],       emoji: '🍛',  meaning: 'curry' },
  { word: 'サラダ',         romaji: 'sarada',                             emoji: '🥗',  meaning: 'ensalada' },
  { word: 'ハンバーガー',   romaji: 'hanbāgā',      alt: ['hanbaagaa'],   emoji: '🍔',  meaning: 'hamburguesa' },
  { word: 'サンドイッチ',   romaji: 'sandoicchi',                         emoji: '🥪',  meaning: 'sándwich' },
  { word: 'チーズ',         romaji: 'chīzu',        alt: ['chiizu'],      emoji: '🧀',  meaning: 'queso' },
  { word: 'バター',         romaji: 'batā',         alt: ['bataa'],       emoji: '🧈',  meaning: 'mantequilla' },
  { word: 'ヨーグルト',     romaji: 'yōguruto',     alt: ['yooguruto'],   emoji: '🫙',  meaning: 'yogur' },
  { word: 'クッキー',       romaji: 'kukkī',        alt: ['kukkii'],      emoji: '🍪',  meaning: 'galleta' },
  { word: 'ドーナツ',       romaji: 'dōnatsu',      alt: ['doonatsu'],    emoji: '🍩',  meaning: 'dona' },
  ...
  { word: 'アイスクリーム', romaji: 'aisukurīmu',   alt: ['aisukuriimu'], emoji: '🍨',  meaning: 'helado' },
  { word: 'オレンジ',       romaji: 'orenji',                             emoji: '🍊',  meaning: 'naranja' },
  { word: 'ストロベリー',   romaji: 'sutoroberī',   alt: ['sutoroberii'], emoji: '🍓',  meaning: 'frutilla' },
  // Tecnología
  ...
  { word: 'コンピュータ',   romaji: 'konpyūta',     alt: ['konpyuuta'],   emoji: '💻',  meaning: 'computadora' },
  { word: 'タブレット',     romaji: 'taburetto',                          emoji: '📱',  meaning: 'tablet' },
  { word: 'インターネット', romaji: 'intānetto',    alt: ['intaanetto'],  emoji: '🌐',  meaning: 'internet' },
  { word: 'イヤホン',       romaji: 'iyahon',                             emoji: '🎧',  meaning: 'auriculares' },
  { word: 'スピーカー',     romaji: 'supīkā',       alt: ['supiikaa'],    emoji: '🔊',  meaning: 'parlante' },
  { word: 'ロボット',       romaji: 'robotto',                            emoji: '🤖',  meaning: 'robot' },
  { word: 'ゲーム',         romaji: 'gēmu',         alt: ['geemu'],       emoji: '🎮',  meaning: 'videojuego' },
  { word: 'プリンター',     romaji: 'purintā',      alt: ['purintaa'],    emoji: '🖨️',  meaning: 'impresora' },
  // Transporte
  { word: 'タクシー',       romaji: 'takushī',      alt: ['takushii'],    emoji: '🚕',  meaning: 'taxi' },
  ...
  { word: 'ヘリコプター',   romaji: 'herikoputā',   alt: ['herikoputaa'], emoji: '🚁',  meaning: 'helicóptero' },
  { word: 'ロケット',       romaji: 'roketto',                            emoji: '🚀',  meaning: 'cohete' },
  { word: 'ボート',         romaji: 'bōto',         alt: ['booto'],       emoji: '⛵',  meaning: 'bote' },
  // Lugares
  ...
  { word: 'アパート',       romaji: 'apāto',        alt: ['apaato'],      emoji: '🏢',  meaning: 'departamento' },
  { word: 'スーパー',       romaji: 'sūpā',         alt: ['suupaa'],      emoji: '🛒',  meaning: 'supermercado' },
  { word: 'デパート',       romaji: 'depāto',       alt: ['depaato'],     emoji: '🏬',  meaning: 'tienda departamental' },
  { word: 'プール',         romaji: 'pūru',         alt: ['puuru'],       emoji: '🏊',  meaning: 'pileta' },
  { word: 'カフェ',         romaji: 'kafe',                               emoji: '☕',  meaning: 'cafetería' },
  { word: 'スタジアム',     romaji: 'sutajiamu',                          emoji: '🏟️',  meaning: 'estadio' },
  { word: 'ビーチ',         romaji: 'bīchi',        alt: ['biichi'],      emoji: '🏖️',  meaning: 'playa' },
  // Deportes
  { word: 'サッカー',       romaji: 'sakkā',        alt: ['sakkaa'],      emoji: '⚽',  meaning: 'fútbol' },
  { word: 'テニス',         romaji: 'tenisu',                             emoji: '🎾',  meaning: 'tenis' },
  { word: 'バスケット',     romaji: 'basuketto',                          emoji: '🏀',  meaning: 'básquet' },
  { word: 'バレー',         romaji: 'barē',         alt: ['baree'],       emoji: '🏐',  meaning: 'vóley' },
  { word: 'スキー',         romaji: 'sukī',         alt: ['sukii'],       emoji: '⛷️',  meaning: 'esquí' },
  ...
  // Música
  { word: 'ギター',         romaji: 'gitā',         alt: ['gitaa'],       emoji: '🎸',  meaning: 'guitarra' },
  ...
  { word: 'スカート',       romaji: 'sukāto',       alt: ['sukaato'],     emoji: '👗',  meaning: 'falda' },
  { word: 'セーター',       romaji: 'sētā',         alt: ['seetaa'],      emoji: '🧣',  meaning: 'suéter' },
  { word: 'ジーンズ',       romaji: 'jīnzu',        alt: ['jiinzu'],      emoji: '👖',  meaning: 'jeans' },
  ...
  { word: 'テーブル',       romaji: 'tēburu',       alt: ['teeburu'],     emoji: '🪑',  meaning: 'mesa' },
  { word: 'エアコン',       romaji: 'eakon',                              emoji: '❄️',  meaning: 'aire acondicionado' },
  { word: 'シャワー',       romaji: 'shawā',        alt: ['shawaa'],      emoji: '🚿',  meaning: 'ducha' },
  ...
  // Países
  { word: 'アメリカ',       romaji: 'amerika',      emoji: '🇺🇸',  meaning: 'Estados Unidos' },
  { word: 'フランス',       romaji: 'furansu',      emoji: '🇫🇷',  meaning: 'Francia' },
  { word: 'イタリア',       romaji: 'itaria',       emoji: '🇮🇹',  meaning: 'Italia' },
  { word: 'スペイン',       romaji: 'supein',       emoji: '🇪🇸',  meaning: 'España' },
  { word: 'ドイツ',         romaji: 'doitsu',       emoji: '🇩🇪',  meaning: 'Alemania' },
  { word: 'ブラジル',       romaji: 'burajiru',     emoji: '🇧🇷',  meaning: 'Brasil' },
  { word: 'メキシコ',       romaji: 'mekishiko',    emoji: '🇲🇽',  meaning: 'México' },
  { word: 'カナダ',         romaji: 'kanada',       emoji: '🇨🇦',  meaning: 'Canadá' },
  { word: 'オーストラリア', romaji: 'ōsutoraria',   alt: ['oosutoraria'], emoji: '🇦🇺',  meaning: 'Australia' },
  { word: 'チリ',           romaji: 'chiri',        emoji: '🇨🇱',  meaning: 'Chile' },
  { word: 'ペルー',         romaji: 'perū',         alt: ['peruu'],  emoji: '🇵🇪',  meaning: 'Perú' },
  { word: 'コロンビア',     romaji: 'koronbia',     emoji: '🇨🇴',  meaning: 'Colombia' },
  { word: 'アルゼンチン',   romaji: 'aruzenchin',   emoji: '🇦🇷',  meaning: 'Argentina' },
  { word: 'イギリス',       romaji: 'igirisu',      emoji: '🇬🇧',  meaning: 'Reino Unido' },
  { word: 'ロシア',         romaji: 'roshia',       emoji: '🇷🇺',  meaning: 'Rusia' },
  // Comida adicional
  { word: 'ステーキ',       romaji: 'sutēki',       alt: ['suteeki'],   emoji: '🥩',  meaning: 'bistec' },
  { word: 'パスタ',         romaji: 'pasuta',       emoji: '🍝',  meaning: 'pasta' },
  { word: 'タコス',         romaji: 'takosu',       emoji: '🌮',  meaning: 'tacos' },
  { word: 'ワッフル',       romaji: 'waffuru',      emoji: '🧇',  meaning: 'waffle' },
  { word: 'オムレツ',       romaji: 'omuretsu',     emoji: '🍳',  meaning: 'omelette' },
  // Deportes adicionales
  { word: 'バドミントン',   romaji: 'badominton',   emoji: '🏸',  meaning: 'bádminton' },
  { word: 'スケート',       romaji: 'sukēto',       alt: ['sukeeto'],   emoji: '⛸️',  meaning: 'patinaje' },
  { word: 'サーフィン',     romaji: 'sāfin',        alt: ['saafin'],    emoji: '🏄',  meaning: 'surf' },
  // Ropa adicional
  { word: 'コート',         romaji: 'kōto',         alt: ['kooto'],     emoji: '🧥',  meaning: 'abrigo' },
  { word: 'ドレス',         romaji: 'doresu',       emoji: '👗',  meaning: 'vestido' },
  { word: 'スーツ',         romaji: 'sūtsu',        alt: ['suutsu'],    emoji: '👔',  meaning: 'traje' },
  { word: 'サンダル',       romaji: 'sandaru',      emoji: '👡',  meaning: 'sandalias' },
  // Objetos adicionales
  { word: 'タオル',         romaji: 'taoru',        emoji: '🪣',  meaning: 'toalla' },
  { word: 'リュック',       romaji: 'ryukku',       emoji: '🎒',  meaning: 'mochila' },
  { word: 'スプーン',       romaji: 'supūn',        alt: ['supuun'],    emoji: '🥄',  meaning: 'cuchara' },
  { word: 'フォーク',       romaji: 'fōku',         alt: ['fooku'],     emoji: '🍴',  meaning: 'tenedor' },
  { word: 'カーテン',       romaji: 'kāten',        alt: ['kaaten'],    emoji: '🪟',  meaning: 'cortina' },
  { word: 'パスポート',     romaji: 'pasupōto',     alt: ['pasupooto'], emoji: '🛂',  meaning: 'pasaporte' },
  { word: 'アプリ',         romaji: 'apuri',        emoji: '📱',  meaning: 'aplicación' },
];
